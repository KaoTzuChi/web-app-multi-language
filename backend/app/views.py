...
def index(request):
    ...
    try:
        ...
        # tempdata = [ {'field1': 'a', 'field2': {'en':'enen'}}, {'field1': 'b', 'field4': 2.22, 'field2': {'es':'eses'} }, {'field1': 'c', 'field3': '20200202', 'field2': {'zh-tw':'twtw'}}]
        # result = test_db.create_documents(tempdata)

        # Find by language: field2.en exists
        # test_db_data = test_db.read_documents_bylang('field2')
